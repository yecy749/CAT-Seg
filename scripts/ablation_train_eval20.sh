...
RESULTS=/media/zpp2/PHDD/output/new-cat-seg-results/Ver20
META_ARCH=ImplicitFusionCATSegVer20
SEG_HEAD=FusionHeadVer20
CLIP_FT=attention
...
MODEL.SEM_SEG_HEAD.DECODER_DIMS [64,32] \
