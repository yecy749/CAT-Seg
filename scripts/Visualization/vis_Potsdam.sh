...
METHOD=Ver0.7
JSON=/media/zpp2/PHDD/output/new-cat-seg-results/$METHOD/EvalResults/eval/Potsdam/inference/sem_seg_predictions.json
...
OUT=/media/zpp2/PHDD/output/new-cat-seg-results/$METHOD/EvalResults/eval/Potsdam/viz
