...
JSON=/media/zpp2/PHDD/output/new-cat-seg-results/$METHOD/EvalResults/eval/FloodNet/inference/sem_seg_predictions.json
...
OUT=/media/zpp2/PHDD/output/new-cat-seg-results/$METHOD/EvalResults/eval/FloodNet/viz
