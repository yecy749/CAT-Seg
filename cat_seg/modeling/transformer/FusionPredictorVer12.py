...
from .FusionAggregator import FusionAggregatorVer07, FusionAggregatorVer08, FusionAggregatorVer09, FusionAggregatorVer09c, FusionAggregatorVer12
...
class FusionPredictorVer12(nn.Module):
    @configurable
    def __init__(
        self,
        *,
        ...
        transformer = FusionAggregatorVer12(
