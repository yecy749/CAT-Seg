...
from .FusionAggregator import FusionAggregatorVer07, FusionAggregatorVer08, FusionAggregatorVer09, FusionAggregatorVer22, FusionAggregatorVer23
...
class FusionPredictorVer23(nn.Module):
    @configurable
    def __init__(
        self,
        *,
        ...
        transformer = FusionAggregatorVer23(
    ...
    def forward(self, x,dino_feat, vis_guidance,dino_guidance,clip_L4_L8_feat, prompt=None, gt_cls=None):
        ...
        # text: [B,N,1,512]
        out = self.transformer(x,dino_feat, text, vis,dino_guidance,clip_L4_L8_feat)
        return out
