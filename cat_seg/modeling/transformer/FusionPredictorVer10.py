...
from .FusionAggregator import FusionAggregatorVer07, FusionAggregatorVer08, FusionAggregatorVer09, FusionAggregatorVer10
...
class FusionPredictorVer10(nn.Module):
    @configurable
    def __init__(
        self,
        *,
        ...
        transformer = FusionAggregatorVer10(
