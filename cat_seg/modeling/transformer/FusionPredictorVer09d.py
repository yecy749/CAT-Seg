...
from .FusionAggregator import FusionAggregatorVer07, FusionAggregatorVer08, FusionAggregatorVer09, FusionAggregatorVer09c, FusionAggregatorVer09d
...
class FusionPredictorVer09d(nn.Module):
    @configurable
    def __init__(
        self,
        *,
        ...
        transformer = FusionAggregatorVer09d(
