...
from .FusionAggregator import FusionAggregatorVer07, FusionAggregatorVer08, FusionAggregatorVer09, FusionAggregatorVer09a
...
class FusionPredictorVer09a(nn.Module):
    @configurable
    def __init__(
        self,
        *,
        ...
        transformer = FusionAggregatorVer09a(
