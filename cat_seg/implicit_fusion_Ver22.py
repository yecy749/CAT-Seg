...
class ImplicitFusionCATSegVer22(nn.Module):
    @configurable
    ...
    def forward(self, batched_inputs):
       ...
       #  clip_patch_last_upsample = self.clip_feat_upsample(clip_patch_last_unfold) # use
        ...
        outputs = self.sem_seg_head(clip_features,dino_feat_down, clip_features_guidance, dino_feat_guidance, clip_L4_L8_feat)
        if self.training:
